 ...
 */
/**
 * @file "modules/computer_vision/team8_method.cpp"
 * @author Y. Naaman
 * Function that takes image location as input and calculates centroid of lines derived from contours of objects.
 */


//#include "team8_method.h"
...
#include "line_centroid_detection.h"
...
int line_centroid_detection(char *img, int width, int height)//, int width, int height)
{
